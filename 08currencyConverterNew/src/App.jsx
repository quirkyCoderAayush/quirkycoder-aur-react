...
function App() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')`
      }}
    >
      {/* Transparent overlay */}
      ...
      <div className="relative w-full">
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          <h1 className='text-center text-white text-4xl underline mb-6'>Currency converter</h1>
          <form onSubmit={(e) => {
            e.preventDefault();
            convert();
          }}>
